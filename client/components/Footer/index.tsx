            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  ...
                  />
                  <Image
                    src="/images/logo/tn-logo-white.png"
                    alt="logo"
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  We ship all over the world form Tamil Nadu.
                </p>
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/people/TamilNative/61553570320319/"
                  ...
                  <a
                    href="https://twitter.com/tamilnative_com"
                    rel="nofollow noreferrer"
                    target="_blank"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  ...
                  <a
                    href="https://www.linkedin.com/company/tamilnative"
                    rel="nofollow noreferrer"
                    target="_blank"
                    aria-label="social-link"
