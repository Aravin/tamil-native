...
export const metadata: Metadata = {
  title: "Error Page | Tamil Native",
  description: "This is Error Page for Tamil Native - A service to send native products to anyone around the globe, based on their request & customization",
  // other metadata
};
